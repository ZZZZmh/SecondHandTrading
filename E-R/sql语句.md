...
CREATE TABLE userinfo(
    ...
    signature VARCHAR(50)   DEFAULT '这个人很懒，什么都没有留下' COMMENT '个性签名' ,
...
CREATE TABLE commodity(
    ...
    commodity_name VARCHAR(32) NOT NULL   COMMENT '名称' ,
    price DECIMAL(32,8) NOT NULL   COMMENT '价格' ,
    image VARCHAR(150) NOT NULL  DEFAULT '暂无图片' COMMENT '图片' ,
    commodity_number INT unsigned NOT NULL  COMMENT '数量 不能为负数' ,
    Introduction VARCHAR(100) NOT NULL  DEFAULT '这人很懒，什么都没留下' COMMENT '介绍' ,
    address VARCHAR(80)  NOT NULL COMMENT '发货地址 第四饭堂C15' ,
...
CREATE TABLE order_form(
    ...
    status TINYINT unsigned NOT NULL  DEFAULT 0 COMMENT '状态 0-待付款，1-已付款未发货，2-已发货，3-已签收，4-拒签，5-申请退款，6-退款成功，7-客服介入，8-订单关闭' ,
    create_time timestamp default CURRENT_TIMESTAMP not null comment '创建时间',
...
CREATE TABLE address(
    user_id VARCHAR(32) NOT NULL   COMMENT '用户id' ,
    address VARCHAR(80) NOT NULL   COMMENT '常用地址' ,
    create_time timestamp default CURRENT_TIMESTAMP not null comment '创建时间',
